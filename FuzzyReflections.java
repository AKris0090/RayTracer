...
public class FuzzyReflections {
    ...
    public FuzzyReflections(int height, int width, PPMFileMaker ppm, Camera camera, Hittable h, int samplesPerPixel, int numBounces) {
        this.height = height;
        this.width = width;
        this.ppm = ppm;
        this.camera = camera;
    ...
    public void initFuzzyReflectionsImage() throws IOException {
